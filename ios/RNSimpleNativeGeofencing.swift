...
//                self.locationManager.requestState(for: geo)
                print("MONITEORED REGIONS: ",self.locationManager.monitoredRegions)
                NSLog("", geo)
                print("GEO LOCATIONS: ", geo)
    ...
    func locationManager(_ manager: CLLocationManager, didEnterRegion region: CLRegion) {
        print("OUTSIDE A CIRCULAR REGION - on ENTER: ")
        if region is CLCircularRegion {
            print("IS A CIRCULAR REGION - on ENTER: ", region)
    ...
    func locationManager(_ manager: CLLocationManager, didDetermineState state: CLRegionState, for region: CLRegion) {
        print("IN STATE: \(state.rawValue) - FOR REGION: ", region)
    ...
    func locationManager(_ manager: CLLocationManager, didVisit visit: CLVisit) {
        print("OUTSIDE A CIRCULAR REGION - on ENTER: ", visit)
//        if region is CLCircularRegion {
//            print("IS A CIRCULAR REGION - on ENTER: ", region)
//            self.handleEvent(region:region, didEnter: true)
//
...
//        }
    ...
    func locationManager(_ manager: CLLocationManager, didExitRegion region: CLRegion) {
        ...
        if region is CLCircularRegion {
            print("IS A CIRCULAR REGION - on EXIT: ", region)
    ...
    func locationManager(_ manager: CLLocationManager, didChangeAuthorization status: CLAuthorizationStatus) {
        ...
        print("INSIDE AUTHORIZATION LOCATION MANAGER")
        if status == .denied {
